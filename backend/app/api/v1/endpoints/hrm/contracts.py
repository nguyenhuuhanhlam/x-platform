...
from app.db.services.hrm.contracts import get_contracts_by_employee
...
async def get__contracts(employee_id: int, db: AsyncSession = Depends(get_db)):
	return await handle_exceptions(get_contracts_by_employee, db, employee_id=employee_id)
